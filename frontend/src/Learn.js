...
const articles = [
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "Modern quant trading works in layers. At the bottom is data — price data, earnings data, news sentiment, satellite imagery of parking lots, credit card transaction data, and much more. Above that are signals — mathematical indicators derived from that data that suggest a trade might be profitable. Above that is a strategy — a set of rules for when to buy and sell based on those signals. And at the top is risk management — rules for how much to bet and when to stop."
      },
      {
        type: "highlight",
        text: "Renaissance Technologies' Medallion Fund — the most successful investment fund in history — has averaged 66% annual returns before fees since 1988. It is run entirely by algorithms with no human discretion in individual trades."
      },
      {
        type: "heading",
        text: "The two main approaches"
      },
      {
        type: "text",
        text: "Trend following strategies bet that stocks moving in one direction will continue moving in that direction. The MA Crossover strategy you can test on QuantWorld is a classic trend-following approach — when the short-term average crosses above the long-term average, the trend is up, so you buy. Mean reversion strategies bet the opposite — that prices that have moved too far in one direction will snap back. RSI is a classic mean reversion indicator."
      },
      {
        type: "callout",
        text: "Try it yourself",
        subtext: "Run the MA Crossover strategy on SPY to see trend-following in action",
        ticker: "SPY",
  ...
  },
  {
    ...
    content: [
      {
        type: "intro",
        text: "A moving average takes the average closing price of a stock over a set number of days, and updates every single day as new prices come in. It smooths out the day-to-day noise of price movements so you can see the underlying trend more clearly."
      },
      {
        type: "heading",
      ...
      {
        type: "text",
        text: "Imagine a stock closes at these prices over 5 days: $10, $12, $11, $13, $14. The 5-day moving average on day 5 is (10+12+11+13+14)/5 = $12. On day 6, if the stock closes at $15, the new 5-day average is (12+11+13+14+15)/5 = $13. The window 'moves' forward every day — hence 'moving' average."
      },
      {
        type: "formula",
        label: "Formula",
        ...
        vars: [
          { var: "n", desc: "Number of days in the window (e.g. 20 or 50)" },
          { var: "P₁...Pₙ", desc: "Closing prices over the last n days" },
        ]
      },
      {
        type: "heading",
        text: "Why 20 and 50 days?"
      },
      {
        type: "text",
        text: "The 20-day moving average (MA20) represents roughly one trading month. It reacts quickly to recent price changes. The 50-day moving average (MA50) represents roughly 2.5 trading months. It moves more slowly and reflects the medium-term trend. Using both together — the MA crossover strategy — gives you a signal: when the fast (MA20) crosses above the slow (MA50), the short-term trend is stronger than the medium-term trend, suggesting upward momentum."
      },
      {
        type: "highlight",
        text: "The 200-day moving average is used by professional investors to determine the overall long-term trend. When a stock is above its 200-day MA, it's considered in a bull trend. Below it — a bear trend. This is one of the most watched levels on Wall Street."
      },
      {
        type: "heading",
        text: "The limitation: lag"
      },
      {
        type: "text",
        text: "Moving averages are lagging indicators — they always react after price has already moved. By the time the MA20 crosses above the MA50, the stock has already been moving up for some time. This means you will never buy at the exact bottom or sell at the exact top using this strategy. In exchange, you get confirmation that a trend is real before committing — reducing the risk of chasing false moves."
      },
      {
        type: "callout",
        text: "Try it yourself",
        subtext: "Test the MA Crossover on TSLA — a volatile stock where the strategy behaves differently",
        ticker: "TSLA",
        strategy: "ma_crossover"
      }
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        vars: [
          { var: "RS", desc: "Average gain over 14 days / Average loss over 14 days" },
          { var: "Average gain", desc: "Mean of all days with positive returns over the last 14 days" },
          { var: "Average loss", desc: "Mean of all days with negative returns over the last 14 days" },
        ]
      },
      {
        type: "text",
        text: "If a stock has been going up every day for 14 days, RS is very high, and RSI approaches 100. If it's been going down every day, RS approaches 0, and RSI approaches 0. Most of the time RSI bounces between 30 and 70, with extremes at either end signaling potential reversals."
      },
      {
        type: "heading",
        text: "The trading rule"
      },
      {
        type: "text",
        text: "The RSI strategy used on QuantWorld is simple: when RSI drops below 30, the stock is considered oversold — it may have fallen too far too fast, and a bounce back is likely, so we buy. When RSI rises above 70, the stock is considered overbought — it may have risen too far too fast, and a pullback is likely, so we sell and hold cash."
      },
      {
        type: "highlight",
        text: "RSI was developed by J. Welles Wilder Jr. and published in his 1978 book 'New Concepts in Technical Trading Systems.' It remains one of the most widely used indicators in trading 45 years later."
      },
      {
        type: "heading",
        text: "The key limitation"
      },
      {
        type: "text",
        text: "RSI works best in range-bound markets — when stocks oscillate up and down without a strong directional trend. In strong bull markets, a stock can stay 'overbought' (RSI above 70) for months while continuing to rise. Selling every time RSI crosses 70 in a bull market means missing most of the gains. This is why no single indicator works in all market conditions — professional quant traders always combine multiple signals."
      },
      {
        type: "callout",
        text: "Try it yourself",
        subtext: "Run the RSI strategy on AMZN over 3 years to see how it handles volatility",
        ticker: "AMZN",
        strategy: "rsi"
      }
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        vars: [
          { var: "Rp", desc: "Portfolio return — your annualized return" },
          { var: "Rf", desc: "Risk-free rate — what you'd earn with zero risk (e.g. US Treasury bills)" },
          { var: "σp", desc: "Standard deviation of returns — how much your returns varied (volatility)" },
        ]
      },
      {
        type: "text",
        text: "The Sharpe ratio divides your excess return (return above the risk-free rate) by your volatility. A higher Sharpe means you earned more return per unit of risk. A Sharpe of 1.0 is generally considered acceptable. Above 2.0 is excellent. The best hedge funds in the world target Sharpe ratios of 1.5-2.5 consistently."
      },
      {
        type: "highlight",
        text: "Warren Buffett's Berkshire Hathaway has a lifetime Sharpe ratio of approximately 0.76 — impressive given the scale, but lower than many quant funds because of the concentrated, long-only nature of the portfolio."
      },
      {
        type: "heading",
      ...
      {
        type: "text",
        text: "Max drawdown measures the worst peak-to-trough decline you would have experienced. If your portfolio hit $100,000, then dropped to $60,000 before recovering, your max drawdown is -40%. This metric is psychologically critical — most investors panic-sell during large drawdowns, locking in losses permanently and missing the recovery. A strategy with a lower max drawdown is easier to hold through, even if its total return is slightly lower."
      },
      {
        type: "text",
        text: "Professional quant funds obsess over drawdown. A fund that makes 15% per year with a max drawdown of -8% is far more valuable than one that makes 20% per year with a -40% drawdown — because the second fund will hemorrhage capital whenever it hits a rough patch, as investors pull their money out in panic."
      },
      {
        type: "callout",
        text: "Try it yourself",
        subtext: "Compare Sharpe ratios between MA Crossover and RSI on the same ticker",
        ticker: "SPY",
        strategy: "ma_crossover"
      }
    ]
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "Quant funds work by finding 'alpha' — returns above what the market would normally give you. Researchers test thousands of hypotheses: does the stock tend to rise the day after earnings? Does high short interest predict future drops? Does satellite data on store parking lots predict retail sales? Most ideas fail. The ones that survive rigorous statistical testing become signals — inputs into a trading model."
      },
      {
        type: "highlight",
        text: "Jim Simons on finding patterns: 'We search through historical data looking for anomalous patterns that we would not expect to occur by chance. We then ask whether these patterns might be expected to persist into the future.'"
      },
      {
        type: "heading",
        text: "The edge is in the details"
      },
      {
        type: "text",
      ...
      {
        type: "heading",
        text: "How this connects to QuantWorld"
      },
      {
        type: "text",
        text: "The strategies on QuantWorld — MA Crossover, RSI — are the simplest building blocks of quantitative trading. Professional quant researchers start from these same foundations and layer enormous complexity on top. Understanding why a simple MA crossover works sometimes and fails other times, why RSI is effective in some market conditions but not others, and what risk-adjusted return really means — this is the conceptual foundation that every quant researcher needs."
      },
      {
        type: "callout",
        text: "Start backtesting",
        subtext: "Apply what you've learned — test a strategy on any stock",
        ticker: "SPY",
        strategy: "ma_crossover"
      }
    ]
  ...
  const illustrations = {
    ...
    "moving-averages": (
      <svg viewBox="0 0 720 280" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", background: "#0f172a" }}>
        ...
        {[60,110,160,210].map(y => <line key={y} x1="60" y1={y} x2="680" y2={y} stroke="#1e293b" strokeWidth="1"/>)}
        {/* Price (noisy) */}
        <polyline points="60,180 90,160 120,175 150,155 180,170 210,145 240,155 270,130 300,145 330,125 360,115 390,120 420,100 450,110 480,90 510,95 540,75 570,80 600,65 630,70 660,55" fill="none" stroke="#334155" strokeWidth="1.5"/>
        {/* MA50 - slow */}
        <polyline points="60,185 120,178 180,168 240,158 300,148 360,135 420,122 480,108 540,92 600,78 660,65" fill="none" stroke="#f59e0b" strokeWidth="2.5" strokeDasharray="6,3"/>
        {/* MA20 - fast */}
        <polyline points="60,175 120,162 180,152 240,138 300,128 360,112 420,95 480,85 540,68 600,60 660,48" fill="none" stroke="#0ea5e9" strokeWidth="2.5"/>
        {/* Crossover point */}
        <circle cx="300" cy="128" r="10" fill="none" stroke="#22c55e" strokeWidth="2"/>
        <circle cx="300" cy="128" r="4" fill="#22c55e"/>
        <text x="300" y="115" textAnchor="middle" fill="#22c55e" fontSize="11" fontWeight="700">CROSSOVER</text>
        {/* Legend */}
        <line x1="80" y1="240" x2="110" y2="240" stroke="#0ea5e9" strokeWidth="2.5"/>
        <text x="116" y="244" fill="#0ea5e9" fontSize="12" fontWeight="600">MA20 (Fast)</text>
        <line x1="240" y1="240" x2="270" y2="240" stroke="#f59e0b" strokeWidth="2.5" strokeDasharray="6,3"/>
        <text x="276" y="244" fill="#f59e0b" fontSize="12" fontWeight="600">MA50 (Slow)</text>
        <line x1="400" y1="240" x2="430" y2="240" stroke="#334155" strokeWidth="1.5"/>
        <text x="436" y="244" fill="#475569" fontSize="12">Price</text>
        <text x="370" y="30" textAnchor="middle" fill="#475569" fontSize="13" fontWeight="600">Moving Average Crossover — MA20 crosses above MA50 = Buy Signal</text>
      </svg>
    ),
    "rsi": (
      <svg viewBox="0 0 720 280" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", background: "#0f172a" }}>
    ...
    "risk-adjusted-returns": (
      <svg viewBox="0 0 720 280" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", background: "#0f172a" }}>
        ...
        {/* Portfolio A - high return, high risk */}
        ...
        {/* Portfolio B - moderate return, low risk */}
    ...
    "quant-funds": (
      <svg viewBox="0 0 720 280" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", background: "#0f172a" }}>
        ...
        {[
          [360, 60, "#0ea5e9", "DATA"],
          [180, 140, "#22c55e", "SIGNALS"],
          [540, 140, "#f59e0b", "RISK MGT"],
          [100, 220, "#a855f7", "STRATEGY"],
          [260, 220, "#0ea5e9", "BACKTEST"],
          [460, 220, "#22c55e", "EXECUTION"],
          [620, 220, "#ef4444", "P&L"],
        ...
        {/* Connections */}
        {[
          [360,60,180,140],[360,60,540,140],
          [180,140,100,220],[180,140,260,220],
          [540,140,460,220],[540,140,620,220],
          [260,220,460,220]
        ].map(([x1,y1,x2,y2],i) => (
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        {article.content.map((block, i) => {
          if (block.type === "intro") return (
            <p key={i} style={{ fontSize: 18, color: "#e2e8f0", lineHeight: 1.9, borderLeft: "3px solid #0ea5e9", paddingLeft: 20, margin: 0 }}>{block.text}</p>
          );
          if (block.type === "heading") return (
            <h2 key={i} style={{ fontSize: 22, fontWeight: 800, color: "#fff", letterSpacing: -0.5, margin: 0, marginTop: 8 }}>{block.text}</h2>
          );
          if (block.type === "text") return (
            <p key={i} style={{ fontSize: 16, color: "#94a3b8", lineHeight: 1.9, margin: 0 }}>{block.text}</p>
          );
          ...
          if (block.type === "formula") return (
            <div key={i} style={{ background: "#0f172a", border: "1px solid #334155", borderRadius: 14, padding: 24 }}>
              ...
              <div style={{ fontFamily: "monospace", fontSize: isMobile ? 14 : 18, color: "#e2e8f0", marginBottom: 16 }}>{block.formula}</div>
          ...
          if (block.type === "callout") return (
            <div key={i} style={{ background: "linear-gradient(135deg, #0ea5e9 0%, #0369a1 100%)", borderRadius: 16, padding: 28, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
              ...
              <button
                onClick={() => navigate(`/backtest?ticker=${block.ticker}&strategy=${block.strategy}`)}
                style={{ padding: "12px 24px", background: "#fff", color: "#0ea5e9", border: "none", borderRadius: 10, fontSize: 15, fontWeight: 700, cursor: "pointer", whiteSpace: "nowrap" }}
              >
                Launch Backtester →
              </button>
            </div>
    ...
    <div style={{ minHeight: "100vh", background: "#0f172a", fontFamily: "Inter, sans-serif" }}>
      ...
      <nav style={{ background: "rgba(15,23,42,0.95)", backdropFilter: "blur(12px)", borderBottom: "1px solid #1e293b", padding: isMobile ? "0 20px" : "0 40px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", gap: 24, alignItems: "center" }}>
          ...
          <span style={{ color: "#0ea5e9", fontSize: 14, fontWeight: 600 }}>Learn</span>
          <button onClick={() => navigate("/backtest")} style={{ padding: "8px 20px", background: "#0ea5e9", color: "#fff", border: "none", borderRadius: 10, fontSize: 14, fontWeight: 700, cursor: "pointer" }}>
            Backtest →
          </button>
        </div>
      </nav>
